...
**Klassen:** 
 [Newspaper](#schema%3ANewspaper) |  [Concept <svg class="svg-external-link" viewBox="0 0 24 24" aria-labelledby="svg-external-link-title"><use xlink:href="#svg-external-link"></use></svg>](../../terms/nl#skos%3AConcept){:target="_blank"} |  [Kranteneditie](#haDes%3ANewspaperIssue) |  [Kranteneditiepagina](#haDes%3ANewspaperIssuePage) |  [Plaats <svg class="svg-external-link" viewBox="0 0 24 24" aria-labelledby="svg-external-link-title"><use xlink:href="#svg-external-link"></use></svg>](../../description/nl#schema%3APlace){:target="_blank"} |  [Rol <svg class="svg-external-link" viewBox="0 0 24 24" aria-labelledby="svg-external-link-title"><use xlink:href="#svg-external-link"></use></svg>](../../description/nl#schema%3ARole){:target="_blank"}
...
| <a id='bf%3AsucceededBy'></a>opgevolgd door <br> <small>[(bf:succeededBy)](http://id.loc.gov/ontologies/bibframe/succeededBy)</small> |  | `0..1` | [Newspaper](#schema%3ANewspaper)  |
| <a id='schema%3AlocationCreated'></a>paginanummer <br> <small>[(schema:locationCreated)](https://schema.org/locationCreated)</small> | Geeft het volgnummer aan van een pagina binnen het grotere object waarvan het deel uitmaakt. | `0..1` | [Plaats <svg class="svg-external-link" viewBox="0 0 24 24" aria-labelledby="svg-external-link-title"><use xlink:href="#svg-external-link"></use></svg>](../../description/nl#schema%3APlace){:target="_blank"}  |
| <a id='bf%3Asupplement'></a>supplement <br> <small>[(bf:supplement)](http://id.loc.gov/ontologies/bibframe/supplement)</small> | Krant die de overheersende krant bijwerkt of anderszins aanvult. | `0..1` | [Newspaper](#schema%3ANewspaper)  |
| <a id='bf%3AsupplementTo'></a>supplement aan <br> <small>[(bf:supplementTo)](http://id.loc.gov/ontologies/bibframe/supplementTo)</small> | Krant die wordt bijgewerkt of anderszins wordt aangevuld met de aanvullende krant. | `0..1` | [Newspaper](#schema%3ANewspaper)  |
...
| <a id='bf%3AprecededBy'></a>voorafgegaan door <br> <small>[(bf:precededBy)](http://id.loc.gov/ontologies/bibframe/precededBy)</small> | Krant die voorafgaat aan de beschreven krant, bijvoorbeeld, is eerder in de tijd of eerder in het verhaal. | `0..1` | [Newspaper](#schema%3ANewspaper)  |
