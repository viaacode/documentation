...
| Element | `premis:premis/premis:object[@xsi:type='premis:representation']/premis:significantProperties/premis:significantPropertiesExtension` |
|-----------------------|-----------|
| Name | PREMIS significant properties extension |
| Description | This extension contains structural and descriptive metadata of the carrier representation. |
| Cardinality | 1..1 |
| Obligation | MUST |

The following elements paths are relative to the `<premis:significantPropertiesExtension>` element.

| Element     | `hasip:numberOfReels`                                                           |
| ----------- | ------------------------------------------------------------------------------- |
...
| Element     | `hasip:hasMissingAudioReels`                              |
| ----------- | --------------------------------------------------------- |
| Name        | Has missing audio reels                                   |
| Description | Whether there is one or more audio reel missing.          |
| Datatype    | [`xsd:boolean`](http://www.w3.org/2001/XMLSchema#boolean) |
| Cardinality | 0..1                                                      |
| Obligation  | MAY                                                       |

| Element     | `hasip:hasMissingImageReels`                              |
| ----------- | --------------------------------------------------------- |
| Name        | Has missing image reels                                   |
| Description | Whether there is one or more image reel missing.          |
| Datatype    | [`xsd:boolean`](http://www.w3.org/2001/XMLSchema#boolean) |
| Cardinality | 0..1                                                      |
| Obligation  | MAY                                                       |

| Element     | `hasip:storedAt`           |
| ----------- | -------------------------- |
| Name        | Stored at physical carrier |
| Description | Element container the reels making up the carrier.                       |
| Cardinality | 1..*                       |
| Obligation  | MUST                       |

| Element     | `hasip:storedAt/hasip:imageReel` |
| ----------- | -------------------------------- |
| Name        | Image reel                       |
...
| Element     | `hasip:storedAt/hasip:audioReel` |
| ----------- | -------------------------------- |
| Name        | Audio reel                       |
...
| Element     | `hasip:storedAt/(hasip:imageReelReel|hasip:audioReel)/hasip:identifier` |
| ----------- | ----------------------------------------------------------------------- |
| Name        | Identifier                                                              |
| Description | TODO                                                                    |
| Datatype    | TODO                                                                    |
...
| Element     | `hasip:storedAt/(hasip:imageReelReel|hasip:audioReel)/hasip:medium` |
| ----------- | ------------------------------------------------------------------- |
| Name        | Storage medium                                                      |
| Description | TODO                                                                |
| Datatype    | TODO                                                                |
...
| Element     | `hasip:storedAt/(hasip:imageReelReel|hasip:audioReel)/hasip:aspectRatio` |
| ----------- | ------------------------------------------------------------------------ |
| Name        | Aspect ratio                                                             |
| Description | TODO                                                                     |
| Datatype    | TODO                                                                     |
...
| Element     | `hasip:storedAt/(hasip:imageReelReel|hasip:audioReel)/hasip:material` |
| ----------- | --------------------------------------------------------------------- |
| Name        | Material                                                              |
| Description | TODO                                                                  |
| Datatype    | TODO                                                                  |
...
| Element     | `hasip:storedAt/(hasip:imageReelReel|hasip:audioReel)/hasip:preservationProblem` |
| ----------- | -------------------------------------------------------------------------------- |
...
| Element     | `hasip:storedAt/(hasip:imageReelReel|hasip:audioReel)/hasip:stockType` |
| ----------- | ---------------------------------------------------------------------- |
| Name        | Stock type                                                             |
| Description | TODO                                                                   |
| Datatype    | TODO                                                                   |
...
| Element     | `hasip:storedAt/(hasip:imageReelReel|hasip:audioReel)/hasip:coloringType` |
| ----------- | ------------------------------------------------------------------------- |
| Name        | Coloring type                                                             |
| Description | TODO                                                                      |
| Datatype    | TODO                                                                      |
...
| Element     | `hasip:storedAt/hasip:imageReel/hasip:hasCaptioning` |
| ----------- | ---------------------------------------------------- |
| Name        | TODO                                                 |
| Description | TODO                                                 |
| Cardinality | 0..*                                                 |
...
| Element     | `hasip:storedAt/hasip:imageReelReel/hasip:hasCaptioning/hasip:openCaptions` |
| ----------- | --------------------------------------------------------------------------- |
| Name        | TODO                                                                        |
| Description | TODO                                                                        |
| Datatype    | TODO                                                                        |
...
| Element     | `hasip:storedAt/hasip:imageReelReel/hasip:hasCaptioning/hasip:openCaptions/hasip:inLanguage` |
| ----------- | -------------------------------------------------------------------------------------------- |
| Name        | TODO                                                                                         |
| Description | TODO                                                                                         |
| Datatype    | TODO                                                                                         |
